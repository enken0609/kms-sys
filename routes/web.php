...
Route::get('/public/races', [App\Http\Controllers\PublicRaceController::class, 'index'])->name('public.races.index');
Route::get('/public/races/{race}', [App\Http\Controllers\PublicRaceController::class, 'showRace'])->name('public.races.show');
...
Route::get('/public/races/{race}/categories/{category}/download/{participant}', [App\Http\Controllers\PublicRaceController::class, 'downloadCertificate'])->name('public.races.categories.download');
